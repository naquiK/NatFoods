      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            <div className="w-16 h-16 bg-stone-900 dark:bg-white rounded-full flex items-center justify-center mx-auto mb-4">
              <svg
            ...
            <h3 className="text-xl font-semibold text-stone-900 dark:text-white mb-2">Quality Assured</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-stone-900 dark:text-white mb-2">Fast Delivery</h3>
            <p className="text-stone-600 dark:text-zinc-400">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-stone-900 dark:text-white mb-2">Customer Care</h3>
            <p className="text-stone-600 dark:text-zinc-400">
        ...
        {settings?.contactInfo?.address && (
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-stone-200 dark:border-zinc-800 p-8 text-center">
            <h3 className="text-2xl font-bold text-stone-900 dark:text-white mb-4">Visit Our Store</h3>
            <p className="text-stone-600 dark:text-zinc-400 mb-2">{settings.contactInfo.address}</p>
            {settings.contactInfo.phone && (
              <p className="text-stone-600 dark:text-zinc-400 mb-2">Phone: {settings.contactInfo.phone}</p>
            )}
            {settings.contactInfo.email && (
              <p className="text-stone-600 dark:text-zinc-400">Email: {settings.contactInfo.email}</p>
            )}
          </div>
        )}
      </div>
